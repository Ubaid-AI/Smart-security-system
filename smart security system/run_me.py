...
class MyTableWidget(QWidget):
    def __init__(self, parent):
        ...
        self.tabs.addTab(self.tab4,"delete")
        self.tabs.addTab(self.tab5,"update")
        ...
        #tab for head and vahecal detecting

        self.tab3.layout = QHBoxLayout(self)
        self.pushButton6 = QPushButton("detector")
        self.pushButton6.setToolTip('Identify from detector')
        self.pushButton6.move(25,25)
        self.pushButton6.clicked.connect(self.detector_h)
        ...
        self.tab1.layout.addWidget(self.pushButton6)
    ...
    def detector_h(self):
        call(["python", "mobilenet_ssd_python.py",])
